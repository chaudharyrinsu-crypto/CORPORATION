...
const Nav = () => {
    ...
    return (
        <>
            <nav className='font-hubot  font-semibold text-[#1f1f1f] w-full '>
                <div className='lg:pt-3 lg:pb-2 border-b border-[#D9D9D8]'>
                    <div className='max-w-[1100px] mx-auto flex flex-col'>
                        ...
                        <ul className='order-2 lg:order-1 flex lg:flex-row flex-col justify-between items-center lg:w-auto w-full lg:px-0 px-3 '>
                            <li onMouseEnter={() => setShowLanguage(!false)} className='lg:flex hidden lg:gap-1.5 justify-between items-center cursor-pointer lg:px-0 px-5 relative bg-amber-200'>
                                ...
                                <ul onMouseLeave={() => setShowLanguage(false)} className={`${showLanguage ? 'block' : 'hidden'} absolute z-10 text-[12px] top-6 py-3 items-center justify-center bg-white border border-[#D9D9D8] rounded-sm`}>
                            ...
                            <li className='relative flex gap-5 justify-between items-center cursor-pointer lg:w-auto w-full text-sm bg-amber-200'>
                                <div className='max-w-[450px] w-full lg:block hidden'>
                                    <span className='absolute left-4 top-1/2 -translate-y-1/2'><TfiSearch /></span>
                                ...
                                <div className='hidden lg:flex lg:flex-row flex-col gap-4 lg:w-auto w-full'>
                                    <Link className='block bg-[#FF4800] hover:bg-[#C93700] duration-500 text-white px-4.5 py-2 rounded-md lg:w-auto' href={``}>Get a demo</Link>
                                    <Link className='block border-2 hover:bg-[#FCECE6] hover:border-[#C93700] border-[#FF4800] hover:text-[#C93700] text-[#FF4800] px-4.5 py-2 rounded-md lg:w-auto  duration-500 ' href={``}>Start 14-day free trial</Link>
                                </div>
                            </li>
                        </ul>
                    </div>
