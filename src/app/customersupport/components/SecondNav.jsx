...
const SecondNav = ({ clickBar }) => {
    // ${clickBar ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}
    return (
        <>
            <div className='lg:order-2 order-1 text-[#2e2e2e] lg:px-0 px-5 font-semibold font-hubot  bg-white lg:bg-[#FCFCFA] py-10 overflow-x-hidden'>
                <div className='max-w-[1100px] mx-auto'>
                    <div className='flex lg:flex-row flex-col justify-between items-center'>
                        ...
                        <ul className={` duration-500 flex lg:flex-row flex-col gap-6 lg:gap-8 lg:justify-between items-start lg:items-center lg:w-auto w-full text-[16px] `}>
                            <li className='flex lg:gap-1.5 justify-between items-center cursor-pointer lg:w-auto w-full'>
                                ...
                                <span className='text-xl lg:hidden block'><MdOutlineArrowForwardIos /></span>
                            </li>
                            <li className='flex lg:gap-1.5 justify-between items-center cursor-pointer lg:w-auto w-full'>
