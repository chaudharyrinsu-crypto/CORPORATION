            ...
            <section className='bg-[#FCFCFA] py-15 font-hubot lg:px-0 px-5'>
                <div className='lg:max-w-[1100px] mx-auto'>
                    ...
                    <div className='flex sm:flex-row flex-col gap-5 justify-between py-10'>
                        ...
                        <p className='lg:w-[40%] sm:w-1/2 w-full tracking-wide'>{caseStudy.description}</p>
                    </div>
                    ...
                    <div className='py-8'>
                        <div className='w-full rounded-2xl border border-[#D9D9D8] p-5'>
                            <div className='flex gap-10 items-center justify-between tracking-wide'>
                                <img className='object-cover rounded-sm h-[400px] ' src={caseStudy.heroimg} alt="heroimg" />
