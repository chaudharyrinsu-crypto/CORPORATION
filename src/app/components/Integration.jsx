        ...
        <>
            <section className='bg-[#FCFCFA] py-15 font-hubot lg:px-0 px-5 tracking-wide'>
                <div className='lg:max-w-[1100px] mx-auto  bg-white border border-[#D9D9D8] h-auto lg:h-[250px] rounded-2xl flex lg:flex-row flex-col justify-between overflow-hidden'>
                    ...
                    <div className='overflow-hidden bg-white lg:h-auto lg:order-2 order-1 h-[200px] w-full lg:w-1/2 relative'>
                        <div className='lg:space-y-15 space-y-10 lg:absolute  overflow-hidden -top-2 -left-10  rotate-[15deg] '>
                            <div className='grid grid-cols-5 gap-2 lg:gap-10 '>
