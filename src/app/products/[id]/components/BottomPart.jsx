    ...
    return (
        <>
            <section className='bg-[#F8F5EE] py-5 font-hubot lg:px-0 px-5'>
                <div className='lg:max-w-[1100px] mx-auto flex sm:flex-row flex-col justify-between items-center'>
                    <div className='flex flex-col gap-4 sm:order-1 order-2'>
                        ...
                        <div className='flex sm:flex-row flex-col items-center gap-5 sm:gap-3 w-full font-semibold py-3'>
                    ...
                    <img className='sm:order-2 order-1' src={product.demo?.image} alt="image" />
                </div>
            </section>
        </>
    )
