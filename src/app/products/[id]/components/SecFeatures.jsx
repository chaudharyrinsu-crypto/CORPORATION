...
const SecFeatures = ({ product }) => {
    return (
        <>
        <div className='2md:py-25 sm:py-20 py-15'>
            <div className='flex sm:flex-row flex-col gap-5 items-center justify-between'>
                <div className='flex flex-col gap-2 items-start sm:w-[50%] w-full'>
                    <h2 className='text-2xl font-semibold'>{product?.solutions?.[1]?.title}</h2>
                    <p className='leading-7'>{product?.solutions?.[1]?.description}</p>
                </div>
