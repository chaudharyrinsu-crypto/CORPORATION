...
const page = () => {
  ...
  return (
    <>
      <section className='bg-[#F8F5EE] font-hubot border-b border-[#D9D9D8]'>
        ...
        <div className='pt-20 px-5 flex flex-col gap-3 lg:gap-6 items-center justify-center'>
          <div className='hidden sm:flex gap-2 lg:gap-3 items-center justify-center'>
          ...
          <div className='flex flex-col gap-3 lg:gap-6'>
            <div className='flex sm:w-full max-w-[1100px] items-center lg:justify-center gap-15'>
              <Link className='lg:hidden inline-block underline underline-offset-2 decoration-1 font-semibold text-sm' href={`/`}>Home</Link>
            </div>
          </div> */}
